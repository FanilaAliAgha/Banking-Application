...
import com.example.bankingapplication.TransactionContract.TransactionEntry;
import com.example.bankingapplication.UserContract.UserEntry;
...
public class SendToUserList extends AppCompatActivity implements SendToUserAdapter.OnUserListener {
    ...
    public void onUserClick(int position) {
        ...
        startActivity(new Intent(SendToUserList.this, home_screen.class));
        finish();
    }
